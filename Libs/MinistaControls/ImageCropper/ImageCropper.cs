...
namespace Minista.UI.Controls
{
    /// <summary>
    /// The <see cref="ImageCropper"/> control allows user to crop image freely.
    /// </summary>
    //[TemplatePart(Name = ScrollingPanelName, Type = typeof(Grid))]
    //[TemplatePart(Name = ScrollingHostName, Type = typeof(ScrollViewer))]
    ...
    public partial class ImageCropper : Control
    {
        ...
        //private ScrollViewer _scrollViewerHost;
        //private Grid _scrollViewerPanel;
        ...
        public Rect CurrentCroppedRect => _currentCroppedRect;
        /// <summary>
        ...
        {
            UnhookEvents();
            //_scrollViewerHost = GetTemplateChild(ScrollingHostName) as ScrollViewer;
            //_scrollViewerPanel = GetTemplateChild(ScrollingPanelName) as Grid;
            ...
            //_scrollViewerHost.ViewChanged += ScrollingHostViewChanged;
            //_scrollViewerPanel.DoubleTapped += PanelDoubleTapped;
        }
        ...
        //    try
        //    {
        //        var position = e.GetPosition(_scrollViewerPanel);

        //        if (_scrollViewerHost.ZoomFactor != 1)
        //        {
        //            _scrollViewerHost.ChangeView(null, null, 1, true);
        //        }
        //        else if (_scrollViewerHost.ZoomFactor == 1)
        //        {

        //            var dispatcher = Window.Current.CoreWindow.Dispatcher;
        //            await dispatcher.RunAsync(CoreDispatcherPriority.High, () =>
        //            {
        //                _scrollViewerHost.ChangeView(position.X, position.Y, 4, true);
        //            });
        //        }
        //    }
        //    catch { }
        ...
        //{
        //    //_scrollViewerPanel.ManipulationMode = _scrollViewerHost.ZoomFactor == 1 ? ManipulationModes.TranslateY | ManipulationModes.TranslateRailsY |
        //    //    ManipulationModes.TranslateX | ManipulationModes.TranslateRailsX
        //    //    | ManipulationModes.System : ManipulationModes.System;

        //    _scrollViewerPanel.ManipulationMode = _scrollViewerHost.ZoomFactor == 1 ? ManipulationModes.TranslateY | ManipulationModes.TranslateX |
        //         ManipulationModes.System : ManipulationModes.System;
        //}
