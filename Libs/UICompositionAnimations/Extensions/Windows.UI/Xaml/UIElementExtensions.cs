...
namespace Windows.UI.Xaml
{
    ...
    public static class UIElementExtensions
    {
        ...
        public static IAnimationBuilder Animation( this UIElement target, FrameworkLayer layer = FrameworkLayer.Composition)
        {
            switch (layer)
            {
        ...
        public static void StopVisualAnimations( this UIElement element,  params string[] properties)
        {
        ...
        public static void SetVisualTranslation( this UIElement element, Axis axis, float translation)
        {
        ...
        public static void SetVisualOffset( this UIElement element, Axis axis, float offset)
        {
            // Get the element visual and stop the animation
            Visual visual = element.GetVisual();
