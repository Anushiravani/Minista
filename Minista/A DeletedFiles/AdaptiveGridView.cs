...
namespace Minista
{
    ...
    /// </summary>
    public class AdaptiveGridView : GridView /*ListView*/
    {
        ...
        public event EventHandler<ScrollViewer> ScrollChanged;
        public AdaptiveGridView()
        {
            if (ItemContainerStyle == null)
                ItemContainerStyle = new Style(typeof(GridViewItem /*ListViewItem*/));
    ...
    public class AdaptiveGridViewX : GridView /*ListView*/
    {
        #region DependencyProperties
        ...
        public static readonly DependencyProperty MinItemHeightProperty =
            DependencyProperty.Register(
                "MinItemHeight",
                typeof(double),
                typeof(AdaptiveGridViewX),
                new PropertyMetadata(1.0, (s, a) =>
                {
                    if (!double.IsNaN((double)a.NewValue))
                    {
                        ((AdaptiveGridViewX)s).InvalidateMeasure();
                    }
                }));
