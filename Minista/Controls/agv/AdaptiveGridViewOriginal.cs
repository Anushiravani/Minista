...
{
    /// <summary>
    /// The AdaptiveGridViewOriginal control allows to present information within a Grid View perfectly adjusting the
    ...
    /// new column.</remarks>
    public partial class AdaptiveGridViewOriginal : GridView
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveGridViewOriginal"/> class.
        /// </summary>
        public AdaptiveGridViewOriginal()
        {
            IsTabStop = false;
        ...
        protected virtual double CalculateItemWidth(double containerWidth)
        {
            ...
            var columns = 3;/*CalculateColumns(containerWidth, DesiredWidth);*/
        ...
        public bool HeightEqualsWidth = true;
    }
    /// <summary>
    /// The AdaptiveGridViewOriginal control allows to present information within a Grid View perfectly adjusting the
    /// total display available space. It reacts to changes in the layout as well as the content so it can adapt
    ...
    /// the items fixed height and the property DesiredWidth sets the minimum width for the elements to add a
    /// new column.</remarks>
    public partial class AdaptiveGridViewOriginal
    {
        /// <summary>
        /// Identifies the <see cref="ItemClickCommand"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty ItemClickCommandProperty =
            DependencyProperty.Register(nameof(ItemClickCommand), typeof(ICommand), typeof(AdaptiveGridViewOriginal), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="ItemHeight"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty ItemHeightProperty =
            DependencyProperty.Register(nameof(ItemHeight), typeof(double), typeof(AdaptiveGridViewOriginal), new PropertyMetadata(double.NaN));
        ...
        public static readonly DependencyProperty OneRowModeEnabledProperty =
            DependencyProperty.Register(nameof(OneRowModeEnabled), typeof(bool), typeof(AdaptiveGridViewOriginal), new PropertyMetadata(false, (o, e) => { OnOneRowModeEnabledChanged(o, e.NewValue); }));

        /// <summary>
        /// Identifies the <see cref="ItemWidth"/> dependency property.
        /// </summary>
        private static readonly DependencyProperty ItemWidthProperty =
            DependencyProperty.Register(nameof(ItemWidth), typeof(double), typeof(AdaptiveGridViewOriginal), new PropertyMetadata(double.NaN));

        /// <summary>
        /// Identifies the <see cref="DesiredWidth"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty DesiredWidthProperty =
            DependencyProperty.Register(nameof(DesiredWidth), typeof(double), typeof(AdaptiveGridViewOriginal), new PropertyMetadata(double.NaN, DesiredWidthChanged));
        ...
        DependencyProperty.Register(nameof(StretchContentForSingleRow), typeof(bool), typeof(AdaptiveGridViewOriginal), new PropertyMetadata(true, OnStretchContentForSingleRowPropertyChanged));

        private static void OnOneRowModeEnabledChanged(DependencyObject d, object newValue)
        {
            var self = d as AdaptiveGridViewOriginal;
