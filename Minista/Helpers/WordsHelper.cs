...
{
    class WordsHelper : IDisposable
    {
        public List<Paragraph> GetParagraph(string text, TypedEventHandler<Hyperlink, HyperlinkClickEventArgs> hyperLinkAction, Color? defaultColor = null, Color? hyperColor = null)
        {
        ...
        Passage GetP(PassageType type = PassageType.Text)
        {
