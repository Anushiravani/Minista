...
namespace Minista.UserControls.Main
{
    ...
    public sealed partial class MediaMainUc : Page, INotifyPropertyChanged
    {
                            ...
                            try
                            {
                                ...
                                if (mtc != null)
                                {
                                    if (mtc.UserTag != null)
                                    {
                                        ...
                                        var cY = CalculateYPosition(item.Position.Y, ImageUserTags.ActualHeight, mtc.ActualHeight);
                                        var trans = new CompositeTransform()
                                        {
                                            TranslateX = cX,
                                            TranslateY = cY
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    if (mtc != null)
                                                                    {
                                                                        if (mtc.UserTag != null)
                                                                        {
                                                                            ...
                                                                            var cY = CalculateYPosition(item.Position.Y, secondGrid.ActualHeight, mtc.ActualHeight);
                                                                            var trans = new CompositeTransform()
                                                                            {
                                                                                TranslateX = cX,
                                                                                TranslateY = cY
        ...
        private async void MenuButtonClick(object sender, RoutedEventArgs e)
        {
            try
            {
                await new MediaDialog(Media, false, FlipView.SelectedIndex).ShowAsync();
            }
            catch { }
        }
...
{
    class SaveToCollectionIconConverter : IValueConverter
    {
