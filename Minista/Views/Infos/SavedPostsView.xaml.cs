...
{
    public sealed partial class SavedPostsView : Page
    {
        public static SavedPostsView Current;
        ...
        private void SavedPostsViewLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    SavedPostsVM.ResetCache();
                    SavedPostsVM.RunLoadMore(true);

                    ScrollableSavedPostUc.SetData(SavedPostsVM, -1);
        ...
        private async void LVItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    var index = SavedPostsVM.Items.IndexOf(media);


                    ScrollableSavedPostUc.Visibility = Visibility.Visible;
                    await Task.Delay(350);
                    ScrollableSavedPostUc.ScrollTo(index);
                }
