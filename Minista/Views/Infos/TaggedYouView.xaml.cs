...
{
    public sealed partial class TaggedYouView : Page
    {
        ...
        public static TaggedYouView Current;
        public TaggedYouView()
        {
        ...
        private void LikedPostViewLoaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    TaggedYouVM.ResetCache();
                    TaggedYouVM.RunLoadMore(true);
                    ScrollableTaggedPostUc.SetData(TaggedYouVM, -1);
        ...
        private async void LVItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                {
                    var index = TaggedYouVM.Items.IndexOf(media);
                    ...
                    ScrollableTaggedPostUc.Visibility = Visibility.Visible;
                    await Task.Delay(350);
                    ScrollableTaggedPostUc.ScrollTo(index);
                }
