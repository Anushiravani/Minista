...
{
    public sealed partial class ExploreClusterView : Page
    {
        //public ExploreClusterGenerator ExploreClusterVM { get; set; } = new ExploreClusterGenerator();
        private InstaTopicalExploreCluster Cluster;
        ...
        public static ExploreClusterView Current;
        public ExploreClusterView()
        {
