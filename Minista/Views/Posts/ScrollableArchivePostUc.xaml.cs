...
namespace Minista.Views.Posts
{
    public sealed partial class ScrollableArchivePostUc : UserControl
    {
        ...
        private async void LoadData()
        {
            try
            {
                ...
                if (!CanLoadFirstPopUp)
                {
                    ...
                    LVPosts.ItemsSource = ArchivePostsVM.Items;
                    await Task.Delay(500);
                    if (Scroll != null)
                        Scroll.ViewChanging += ArchivePostsVM.ScrollViewChanging;
                    if (SelectedIndex != -1)
                        LVPosts.ScrollIntoView(ArchivePostsVM.Items[SelectedIndex]);
        ...
        private void RefreshControlRefreshRequested(Microsoft.UI.Xaml.Controls.RefreshContainer sender, Microsoft.UI.Xaml.Controls.RefreshRequestedEventArgs args)
        {
            ...
            {
                if (ArchivePostsVM != null)
                    ArchivePostsVM.RunLoadMore(true);
            }
        }
