...
{
    public sealed partial class ScrollableUserShopPostUc : UserControl
    {
        ...
        private UserDetailsShopMediasGenerator MediaGeneratror;
        private bool CanLoadFirstPopUp = false;
        public ScrollableUserShopPostUc()
        {
        ...
        {
            User = user;
            ScrollableUserShopPostVM.User = user;
        }
        public async void SetData(InstaUserShort user, UserDetailsShopMediasGenerator mediaGeneratror)
        {
            try
            {
                User = user;
                ...
                if (!CanLoadFirstPopUp)
                {
                    ...
                    ScrollableUserShopPostVM.SetInfo(User, MediaGeneratror, Scroll);
                    LVPosts.ItemsSource = ScrollableUserShopPostVM.MediaGeneratror.Items;
        ...
        public void ScrollTo(int index)
        {
            ...
            {
                SelectedIndex = index;
                ScrollableUserShopPostVM.MediaGeneratror.IsLoading =MediaGeneratror.IsLoading = false;
                if (SelectedIndex != -1)
                    LVPosts.ScrollIntoView(ScrollableUserShopPostVM.MediaGeneratror.Items[SelectedIndex]);
            }
            catch { }
        }
        ...
        private void RefreshControlRefreshRequested(Microsoft.UI.Xaml.Controls.RefreshContainer sender, Microsoft.UI.Xaml.Controls.RefreshRequestedEventArgs args)
        {
            using (var RefreshCompletionDeferral = args.GetDeferral())
                ScrollableUserShopPostVM.MediaGeneratror?.RunLoadMore(true);
        }
