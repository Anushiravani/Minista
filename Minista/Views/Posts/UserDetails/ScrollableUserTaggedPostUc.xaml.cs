...
{
    public sealed partial class ScrollableUserTaggedPostUc : UserControl
    {
        ...
        private UserDetailsTaggedMediasGenerator MediaGeneratror;
        private bool CanLoadFirstPopUp = false;
        public ScrollableUserTaggedPostUc()
        {
        ...
        {
            User = user;
            ScrollableUserTaggedPostVM.User = user;
        }
        ...
        public void ScrollTo(int index)
        {
            try
            {
                ...
                ScrollableUserTaggedPostVM.MediaGeneratror.IsLoading= MediaGeneratror.IsLoading = false;
                if (SelectedIndex != -1)
                    LVPosts.ScrollIntoView(ScrollableUserTaggedPostVM.MediaGeneratror.Items[SelectedIndex]);
            }
            catch { }
        }
